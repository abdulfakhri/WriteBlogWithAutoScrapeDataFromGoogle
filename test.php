...
$search = $_GET['results'];if(isset($_GET['results']) && $_GET['results'] != "")
	...
	// now, process the JSON string	$json = json_decode($body);	// print out the Array	print_r($json);	// now have some fun with the results...
}?></body></html>