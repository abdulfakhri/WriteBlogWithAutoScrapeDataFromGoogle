...
<div class="form-group col-md-10" >
  <label class="control-label" for="article_content">Content</label>
    ...
    <textarea class="form-control" id="article_content" name="article_content" rows="20"><?php if (isset($_POST['article_content'])) {echo $_POST['article_content'];}
?></textarea>
