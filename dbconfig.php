...
<html lang="en">
    ...
    <body>
        ...
        <div class="w3-bar w3-top w3-red w3-large" style="z-index:4">
            ...
            <span class="w3-bar-item w3-right"><button   class="" style="width:auto;"><a href="index.php">Home</a></button></span>
        </div>
        <br>
        <!-- Sidebar/menu -->
       <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:246px;" id="mySidebar"><br>
         ...
         <hr>
		   ...
		   <button   class="" style="width:auto;"><a href="logout.php">Logout</a></button>
...
?>   
    ...
    <div class="content" style="max-width:1600px;margin-top:83px">
                        ...
                        <tbody>
		                  ...
		                  <td><a href="http://blog.irontin.com/index.php?id=<?php echo $res2['article_id'];?>" onclick="w3_close()" class="w3-bar-item w3-button w3-center w3-padding-16"><?php echo $res2['article_name'];?></a></td>
		                 <?php
