...
$sql="insert into userlog(action,userIp) values('$action','$uip')";
...
<html lang="en">
    ...
    <body>
        ...
        <div class="w3-bar w3-top w3-red w3-large" style="z-index:4">
            ...
            <span class="w3-bar-item w3-right"><button   class="" style="width:auto;"><a href="login.php">Login</a></button></span>
        </div>
        <br>
        <!-- Sidebar/menu -->
...
?>   
     ...
     <div class="list">
                        ...
                        <tbody>
		                  ...
		                  <td style="text-align:left;"><a href="http://blog.irontin.com/index.php?id=<?php echo $res2['article_id'];?>" onclick="w3_close()" class="w3-bar-item w3-button w3-center w3-padding-16"><?php echo $res2['article_name'];?></a></td>
		                 <?php
